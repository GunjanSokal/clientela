...
?>   
   ...
   <div class="col-sm-4 col-md-3">
    ...
    <div class="views-field views-field-field-item-image"><?php 
        if($values['img']){
             ?>
            <a href="<?php echo $base_url; ?>/featured/product/detail/<?php echo $item_id; ?>"><img src = <?php echo $values['img']; ?> > </a>
              <?php  } 
                 else{         
                    ?>
                <a href="\'.$base_url.\'/featured/product/detail/<?php echo $item_id; ?>"><img src = <?php print $base_url; ?>/sites/default/files/default_images/default_image.png    alt = t("image") ></a>          
            ...
            <div class="field-content">   
                ...
                <?php 
                  if(isset($_SESSION['featured_product_id']) && isset($_SESSION['redirect_user_to_wishlist_page'])){  ?>
                    <button onclick="removeWishlistedItem($values['product_id'],$nid)">Remove</button>
                    <?php
                          unset($_SESSION['featured_product_id']);
                          unset($_SESSION['redirect_user_to_wishlist_page']);
                  }
                ?>
